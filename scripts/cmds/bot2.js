...
module.exports = {
  ...
  onChat: async function ({ api, event }) {
    const randomReplies = ["Bolo jaan ki korte pari tmr jonno 🥹🥹", "আর কত বার ডাকবা ,শুনছি তো 🤷🏻‍♀", "আম গাছে আম নাই ঢিল কেন মারো, তোমার সাথে প্রেম নাই বেবি কেন ডাকো 😒🫣", "দূরে যা, তোর কোনো কাজ নাই, শুধু 𝗯𝗯𝘆 𝗯𝗯𝘆 করিস  😉😋🤣", "Hop beda😾,Boss বল boss😼", "𝗕𝗯𝘆 𝗯𝗼𝗹𝗹𝗮 𝗽𝗮𝗽 𝗵𝗼𝗶𝗯𝗼,,😒😒", "𝗕𝗯𝘆 বলে অসম্মান করচ্ছিছ,😰😿", "বলেন sir__😌", "তোর বিয়ে হয় নি 𝗕𝗯𝘆 হইলো কিভাবে,,🙄", "𝗕𝗯𝘆 বললে চাকরি থাকবে না", "বার বার ডাকলে মাথা গরম হয় কিন্তু 😑😒", "বলো ফুলটুশি_😘", "ভুলে জাও আমাকে 😞😞", "Ato gulo bby k samlate parsi nah 😫😫"];
